...
const REPLIED = /\b(?:(?:they|she|he) (?:replied|responded|wrote back|got back(?: to (?:us|me))?|answered|emailed (?:back|us|me))|heard back|reply from|response from)\b/i;
const REACHED = /\b(?:reached out|emailed (?:them|him|her)|wrote to (?:them|him|her)|sent (?:them |him |her )?(?:an? )?(?:email|note|message|linkedin message|dm|intro email)|messaged|pinged|followed up|following up|left (?:a )?(?:message|voicemail)|texted)\b/i;
